                ...
                <section class="mt-3">
                    ...
                    @if (count($categories) == 0)
                        <div class="card border-0 w-100 h-100 px-3 py-5 text-muted text-center">
                            <h1 class="mb-3">😥</h1>
                            <span>Нет доступных категорий, пожалуйста, <a href="{{ route('category') }}" class="text-decoration-none">создайте</a> новую.</span>
                        </div>
                    @else
                        <div class="card border-0 w-100 mb-3 p-2">
                            <div class="row no-gutters">
                                ...
                                <div class="col-12 col-md ml-0 ml-md-2 order-1 order-md-2">
                                    <input class="form-control h-100" type="text" id="name" value="" placeholder="Название заметки">
                                </div>
